...
ActiveRecord::Schema.define(version: 2019_10_23_133314) do
  ...
  create_table "feelings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
